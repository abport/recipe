  ...
  recipeResults.forEach((recipeResult) => {
    ...
    <div class="item">
      ...
      <div class="recipe-desc">
        <p class="item-data"><strong>Calories:</strong> ${recipeResult.recipe.calories.toFixed(
          2
        )}</p>
        <p class="item-data"><strong>Diet Label:</strong> ${
          recipeResult.recipe.dietLabels
        }</p>
        <p class="item-data"><strong>Health Label:</strong> ${
          recipeResult.recipe.healthLabels
        }</p>
        <p class="item-data"><strong>Source:</strong> ${
          recipeResult.recipe.source
        }</p>
      </div>
  </div>
    `;
